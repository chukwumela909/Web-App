...
const navigationItems = [
  ...
  { name: 'Expenses', href: '/dashboard/expenses', icon: BanknotesIcon, permission: 'expenses:read' },
  { name: 'Reports', href: '/dashboard/reports', icon: PresentationChartBarIcon, permission: 'reports:basic_read' },
  { name: 'Suppliers', href: '/dashboard/suppliers', icon: TruckIcon, permission: 'inventory:read' },
...
const pageTitles: Record<string, { title: string; subtitle?: string }> = {
  ...
  '/dashboard/debtors': { title: 'Debtors', subtitle: 'Track who owes you and their payments' },
